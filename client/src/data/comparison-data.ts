export const KB = {
  swmm5: {
    ...
    sources: [
      ...
      {
        label: "EPA/600/R-06/097 — SWMM Quality Assurance Report: Dynamic Wave Flow Routing (Sept 2006)",
        url: "https://www.epa.gov/water-research/storm-water-management-model-swmm",
      ...
      },
      {
        ...
        notes: "Detailed comparison of node-link solution, area calculation, Froude number handling, dry network simulation.",
      },
      {
    ...
    sources: [
      {
        ...
        notes: "Preissmann 4‑point scheme, θ≈0.65, Newton–Raphson with double-sweep, base flow, Preissmann slot, conduit solution models.",
      },
      {
        label: "Autodesk InfoWorks ICM Product Overview",
        url: "https://www.autodesk.com/products/infoworks-icm/overview",
        notes: "Describes engine as 'fast, robust, stable, and efficient'.",
      },
      {
        ...
        notes: "Documents addition of EPA SWMM5 engine as alternative solver (December 2019).",
      },
      {
      ...
      },
      {
        label: "QA/QC Hydraulic Comparison of ICM, SWMM5 and XPSWMM (ICWMM 2018)",
        url: "https://www.icwmm.org/Archive/2018-C027-08/qa-qc-hydraulic-comparison-of-infoworks-icm-swmm5-and-xpswmm-for-gravity-partial-pressure-and-force",
        notes: "4-point implicit link solution, computational points, Froude number handling, base flow mechanism.",
      },
      {
      ...
      },
      {
        ...
        url: "",
        notes: "Standard hydraulic engineering reference for Saint-Venant equations and numerical methods.",
      },
    ],
  },
};
